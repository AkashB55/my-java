...
public class ElementPercentage {
	...
	public static void getCharPercentage(String str) {
		...
		System.out.println("special chars % ----> " + formatter.format(specCharsPercentage));
	...
	public static void main(String[] args) {
		...
		getCharPercentage("Akash");
		getCharPercentage("Akash java program");
		getCharPercentage("Akash java program 12345");
		getCharPercentage("Akash  java program 12345 %%%***");
		getCharPercentage("A");
		getCharPercentage("1");
		getCharPercentage("1$");
